            ...
            <section className="contact contacttextt">
              <div className="content" data-aos="flip-left" data-aos-delay="100">
                ...
                <div className="section-title">
                  ...
                  <p data-aos="fade-up" data-aos-delay="400"> Feel free to contact with bestbid. If you have any query then please submit your quetions with your details. Keep bidding!!!</p>
                </div>
              </div>
